	  ...
	  <div class="widget-header widget-header-large">
		...
		<div class="control-group">
			...
			<div class="controls">
				...
				<input class="ace-tooltip" type="text" id="orderid" placeholder="please input orderid" title="" data-placement="bottom" >
			    <button type="button" class="btn btn-primary" id="searchid">查询</button>
			</div>
		</div>
			...
			<div class="widget-body">
				<div class="widget-main">
					<ul class="unstyled spaced2">
						<li><h4>订单ID:  <b class="red">${order.id }</b><h4></li>
								<h4><li>原始订单ID:  <b class="red">${order.Original_ID }</b><h4></li>
							
								<h4><li>订单状态 : <b class="red">${order.Status }  </b><h4></li>
								<h4><li>订单地址:  <b class="red">${order.Address }  </b><h4></li>
							<h4>	<li>收货人: <b class="red">${order.Name }  </b><h4></li>
								<h4><li>电话:  <b class="red">${order.Tel }  </b><h4></li>
								<h4><li class="divider"></li>
						...
						<tbody>
														...
														<c:choose>
															<c:when test="${not empty itermList}">
																...
																<c:forEach items="${itermList}" var="detail"
																	varStatus="vs">
																	<tr>
				...
				<div class="row-fluid">
					<div class="span5 pull-right">
						<h4 class="pull-right">
						Total amount : <span class="red">${order.TotalPrice }    </span>	
					</div>
