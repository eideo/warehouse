...
<form method="post" id="myform" action="products/readExcel.do" enctype="multipart/form-data">
<input type="submit" value="upload" class="btn btn-app btn-success">
<input type="file" name="csv_file" id="csv_file" onchange="fileSelected();"  accept=".xls,.csv,.xlsx">
</form>
		...
		<table id="table_report" class="table table-striped table-bordered table-hover">
			...
			<thead>
				<tr>
					...
					<th>NAME_CN</th>
					<th> Remark</th>
					<th><i class="icon-calendar"></i>Update</th>
