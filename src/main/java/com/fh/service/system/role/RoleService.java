...
public class RoleService{
	...
	public List<Clients> listAllDept() throws Exception {
	
		List<Clients> list =(List<com.fh.entity.warehouse.Clients>) dao.findForList("WarehouseMapper.listAlLClientsBybean", null);
