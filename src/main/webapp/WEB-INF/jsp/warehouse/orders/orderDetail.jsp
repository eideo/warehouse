				...
				<ul class="nav nav-list">
					...
					<li class="active open">
					  ...
					  <ul class="submenu">
						...
						<li class="active"><a href="invoice.html"><i class="icon-double-angle-right"></i> Invoice</a></li>
	 ...
	 <div class="widget-box transparent invoice-box">
	  <div class="widget-header widget-header-large">
		...
		<div class="widget-toolbar no-border invoice-info">
			<span class="invoice-info-label">Invoice:</span> <span class="red">#121212</span>
			<br />
			<span class="invoice-info-label">Date:</span> <span class="blue">03/03/2013</span>
		</div>
			...
			<div class="row-fluid">
				<div class="row-fluid">
					...
					<div class="span6">
						...
						<div class="row-fluid">
							<ul class="unstyled spaced">
								<li><i class="icon-caret-right green"></i>Street, City</li>
								<li><i class="icon-caret-right green"></i>Zip Code</li>
								<li><i class="icon-caret-right green"></i>State, Country</li>
								<li class="divider"></li>
